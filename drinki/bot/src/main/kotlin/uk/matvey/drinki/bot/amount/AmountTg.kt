...
object AmountTg {
    ...
    fun amountsKeyboard(): List<List<InlineKeyboardButton>> {
        return listOf(
            ...
            listOf(InlineKeyboardButton("$DELETE Remove").callbackData("/drink_delete_ingredient"))
        )
    }
    ...
    private fun amountsRow(vararg amounts: String): List<InlineKeyboardButton> {
